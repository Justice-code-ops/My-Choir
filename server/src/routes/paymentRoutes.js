...
// Member self-service dues
router.get("/me/summary", paymentController.getMyPaymentSummary);
router.get("/me/history", paymentController.getMyPaymentHistory);
router.post(
  "/me/simulate",
  [
  ...
  validate,
  paymentController.simulateMemberPayment
);
